...
let compInitVectors (day0 : float []) (day1: float []) =
    ...
    printfn "- Initial speed vector,........v0: < %A AU,   %A AU >" (vX) (vY)                    // Jf. tegning. Initiel hastighedsvektor. Position1 <x1,y1> minus Position0 <x0,y0> giver en retningsvektor.
    printfn "- Length of v0: %A AU" (vLength)                                        // Længden af initiel hastighedsvektor.
